class Solution {
    ...
    topKFrequent(nums, k) {
        ...
        console.log("kMostRepeated: ", kMostRepeated);
        console.log("kMostRepeated: ", kMostRepeated[0][0]);
        if (k===1){
            return [kMostRepeated[0][0]];
        }
        let skMostRepeated = kMostRepeated.sort((a,b)=> b[1] - a[1])
        console.log("skMostRepeated: ", skMostRepeated);
        console.log("skMostRepeated: ", skMostRepeated[0][0]);
        let result = [];
        for(let i = 0; i < k; i++){
